  ...
  return (
    <div 
      ...
      <div className="left">
        ...
        <br/>
        <p>
          Epicodus has provided a framework for over 250 hours of experience, and nearly 20 projects in each of the following languages: C#/.Net, React, & Javascript. I am currently working as an individual contributor for VALIDATE, LLC, working on a React web application that is nearly ready for its beta launch.
      </p>
        {/* <p>
          While I don't boast to have the most experience writing code, as a representation of myself, I have confidence in leveraging my abilities as a self-starter to learn and fulfill all communicated objectives, while maintaining best practices along the way (GIT, pair-programming, CRUD, REST)
        </p> */}
      </div>
      <div className="right">
